...
.. hint:: ID магазина и пароли настраиваются в личном кабинете `robokassa.com`_. Для корректной работы необходимо настроить WebHook в личном кабинете платежного сервиса, указав URL: https://torrow.net/payments/hooks/robokassa
...
.. hint:: Ссылка, имя пользователя и пароль настраиваются в личном кабинете `paykeeper.ru`_. Для корректной работы необходимо настроить WebHook в личном кабинете платежного сервиса, указав URL: https://torrow.net/payments/hooks/paykeeper
...
.. hint:: ИД терминала и пароль настраиваются в личном кабинете `t-bank.ru`_. Для корректной работы необходимо настроить WebHook в личном кабинете платежного сервиса, указав URL: https://torrow.net/payments/hooks/tinkoff
...
.. hint:: Имя пользователя и пароль настраиваются в личном кабинете `alfabank.ru`_. Для корректной работы необходимо настроить WebHook в личном кабинете платежного сервиса, указав URL: https://torrow.net/payments/hooks/alfabank
...
.. hint:: Идентификатор магазина и секретный ключ предоставляется при подключении в `yookassa.ru`_. Для корректной работы необходимо настроить WebHook в личном кабинете платежного сервиса, указав URL: https://torrow.net/payments/hooks/yookassa
...
.. hint:: Для работы API потребуются публичный и секретный ключи. Ключи создаются в личном кабинете на `p2p.qiwi.com`_. Для корректной работы необходимо настроить WebHook в личном кабинете платежного сервиса, указав URL: https://torrow.net/payments/hooks/qiwip2p
