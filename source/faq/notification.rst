...
**Если Вам необходимо подключить оповещения (уведомления о записи) клиентам или исполнителям в услуге, воспользуйтесь инструкцией:**
...
Полный перечень параметров приведен ниже в разделе :ref:`notification-parameters-label`.
...
.. _notification-parameters-label:

Параметры шаблона текстов email и Telegram уведомлений
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
При использовании шаблонных текстов email уведомлений, которые настраиваются в виде **{% include 'email_header' %}Вы записаны на встречу.{% include 'email_footer' %}** , можно указать дополнительные параметры, чтобы настроить отображаемую в уведомлении информации.
