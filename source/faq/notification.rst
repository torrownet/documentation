...
Для email-оповещения также можно настроить текст письма - поле **Сообщение**

.. figure:: media/notification/notification22.png
    :scale: 42 %
    :alt: alternate text
    :align: center
...
8. Другой вид оповещения можно добавить, нажав на **Добавить оповещение**
...
Установите необходимое время подтверждения
