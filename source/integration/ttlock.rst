...
* **message** - шаблон сообщения, которое будет добавлено в описание заказа. По умолчанию: *** Код доступа #passcode *** , где вместо #passcode будет добавлен код доступа к электронному замку.
