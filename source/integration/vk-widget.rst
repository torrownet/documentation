...
-------------------------------------------------------------
Показать несколько услуг в группе ВКонтакте
-------------------------------------------------------------

В группе **ВКонтакте** можно установить только одну кнопку открытия виджета Torrow (запуска мини-приложения Torrow). 
Чтобы показать пользователю несколько услуг, требуется создать группирующую Услугу, в которую вложить другие услуги, на которые будут записываться клиенты.
...
3. При настройке мини-приложения Torrow в группе ВКонтакте нужно выбрать группирующую услугу в соответствии с инструкцией выше.
