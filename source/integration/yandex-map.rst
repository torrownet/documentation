...
5. В общих настройках контакта укажите **хештеги**: #YandexBooking и категорию бизнес в #<категория>:YandexBookingRubrics (например, #Салон красоты:YandexBookingRubrics). Пример заполнения на изображении ниже. После заполнения сохрание изменения, нажав на |галка|.
