...
Если у вас специфические виды услуг, то требуется пройти `процесс подключения к API онлайн-записи`.
...
.. _`процесс подключения к API онлайн-записи`: https://yandex.ru/support/business-priority/ru/manage/booking-api-partners
