...
2. Важно получить токен Telegram бота для настройки WebHook Torrow  (пример токена **6126237741:AAFQKNyn1jhScXSGsYCh_yxwWDT578ARMGA**). Как получить токен - читайте инструкцию на выбранную вами систему. Если вы подключаете **Torrow Chat Bot**, то токен получать не нужно, вместо него нужно написать **TorrowChatBot**.
