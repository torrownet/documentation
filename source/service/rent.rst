...
.. figure:: media/rent/rent12.png
    :scale: 42 %
    :alt: alternate text
    :align: center

13.  Ваша услуга типа **Аренда** готова! Осталось добавить **ресурсы** (:ref:`resources-label`).

.. figure:: media/rent/rent13.png
    :scale: 42 %
    :alt: alternate text
    :align: center
