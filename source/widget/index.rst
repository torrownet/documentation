...
:ref:`Полный виджет<widgetdifiform2>`
...
.. figure:: media/WidgetFullV.png
      ...
      Окошко приложения может открываться прямо у Вас на сайте! :ref:`Подробнее!<widgetdifiform2>`

.. sidebar:: Примеры использования:
...
.. note:: **Упрощенная версия виджета** - обладает ограниченными функциями (только выбор времени и контактная информация). Недоступен для услуг с ресрусами.
...
.. figure:: media/widgetV.png
      ...
      Пример упрощенного виджета. :ref:`Подробнее!<widgeteasyform2>`  
