...
16. Перейдите к **Обработке закзаов в очереди**. Нажмите наполе **Выполнить операцию с заказом**.
...
18. Установите значение **Задержки при возврате**. Это время, на которое будет отложен заказ при освобождении ресурса.
...
19. Перейдите к **Участие ресурса в заказе**. Нажмите на поле **Изменить участие на**.
...
20. Выберите необходмый тип участия ресурса.
...
21. Нажмите на поле **Доступность ресурса во время заказа**
...
22. Выберите **тип доступности** ресурса во время заказа.
...
23.  Поставьте |галка| в **Не показывать в календаре**, чтобы в расписании исполнителя отображался заказ. **Оставьте поле пустым**, если этого не нужно.
...
24. Если Вы хотите переместить шаг выше, то нажмите на кнопку **Переместить**. В таком случае клиент увидит этот шаг раньше других.
...
25. Сохраните изменения, для этого нажмите на |галка|. Если Вы хотите **добавить другие шаги**, нажмите на надпись повторите действия, **начиная с пункта 2**.
...
26. **Готово!** Вы настроили **Исполнение** услуги.
