...
.. hint:: **Подсказка:** Рекомендуем выбрать тип доступности **По ссылке**.
...
.. hint:: **Подсказка:** Уникальное имя будет отображаться в **ссылке** Вашего контакта.
...
.. hint:: **Подсказка:** Рекомендуем выбрать статус доступности **По календарю визитки**.
...
.. hint:: **Подсказка:** В расписании визитки Вы можете посмотреть перечень событий, которые относятся **конкретно к данной визитке**. В **Личном календаре** мы можем видеть общий список событий с градцией по цвету в зависимости от типа визитки участника/исполнителя.
